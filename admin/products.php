            ...
            <tbody>
                <?php foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td class="p-3 border border-gray-300"><?= htmlspecialchars($product['brand']); ?></td>
                        <td class="p-3 border border-gray-300">
                            <div class="flex items-center space-x-2">
                                <a href="./editProduct.php?id=<?=  $product['id'] ?>" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Edit</a>
                                 <!-- Delete Button -->
